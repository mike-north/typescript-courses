...
// @ts-ignore-error
const failLemonName: number = fruitsWithKgMass.lemon.name; // $ExpectType number
...
// Array.prototype.reduce, but for Dict
function reduceDict<T, S>(inputDict: Dict<T>, reducerFunction: (currentVal: S, dictItem: T, key: string) => S, initialValue: S): S {
